...
public class CharacterJackPotSkill
{
    Character character;
    BattleManager battleManager { get { return character.battleManager; } }
    CharacterStateMachine stateMachine { get { return character.stateMachine; } }

    WaitForEndOfFrame waitForEndOfFrame = new WaitForEndOfFrame();
    WaitForSeconds waitForSeconds = new WaitForSeconds(0.4f);

    public CharacterJackPotSkill(Character character)
    {
        this.character = character;
    }

    public void JackPotSkill(int itemID)
    {
        switch (itemID)
        {
            case 0:
    ...
    bool MoveTowardsCharacter(Vector3 target)
    {
    ...
    bool LerpCharacter(Vector3 startPos, Vector3 target, float curMoveTime)
    {
        return target != (character.transform.position =
